	...
	<div class="container">
		...
		<div class="table-responsive col-sm-12 col-md-9 mx-auto">
			<table class="table table-bordered">
				<tbody>
					<?
					$output = $db->query('SELECT * FROM category');
					foreach ($output as $out) {
						echo "<tr>";
						echo  "<td class='d-flex justify-content-between'><span>" . $out["name_category"] . "</span><a type='button' href=?del_id=" . $out['id_category'] . " ><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' class='text-danger bi bi-x-circle text-center' viewBox='0 0 16 16'>
